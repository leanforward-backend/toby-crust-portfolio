...
const project = [
  ...
  },
  {
    ...
    demoUrl:
      "https://23-mddn342.github.io/project-2-randomised-collections-TobyCrust/",
  },
];
    ...
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-forground mb-12 max-w-2xl mx-auto">
          Here are projects I have created in my spare time. I would be very
          happy to chat about the type of work I have done for my previous
          companies, as I am not able to display that here.
        </p>
        <Carousel
          opts={{
            align: "start",
          ...
          <CarouselContent>
            {project.map((projects, key) => (
              <CarouselItem
                ...
                onClick={() =>
                  projects.demoUrl
                    ? window.open(projects.demoUrl, "_blank")
                    : null
                }
              >
